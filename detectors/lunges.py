...
class LungesDetector(BaseExercise):
    ...
    def process(self, landmarks) -> dict:
        ...
        if left_knee_angle <= right_knee_angle:
            front_knee_angle, front_hip_idx, front_knee_idx, front_ankle_idx, shoulder_idx_for_torso = left_knee_angle, self.LEFT_HIP, self.LEFT_KNEE, self.LEFT_ANKLE, self.LEFT_SHOULDER
        else:
            front_knee_angle, front_hip_idx, front_knee_idx, front_ankle_idx, shoulder_idx_for_torso = right_knee_angle, self.RIGHT_HIP, self.RIGHT_KNEE, self.RIGHT_ANKLE, self.RIGHT_SHOULDER     
